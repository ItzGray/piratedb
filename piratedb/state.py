...
from .lang_files import LangCache, LangKey, UnitLangKey, DescLangKey, RankTooltipLangKey, OtherLangKey
...
class State:
    ...
    def make_other_lang_key(self, key: bytes) -> OtherLangKey:
        return OtherLangKey(self.cache, key)
